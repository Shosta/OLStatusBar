//
//  OLStatusBarDemoDownToUpWithSpinnerViewController.m
//  OLStatusBarDemo
//
...
@implementation OLStatusBarDemoDownToUpWithSpinnerViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
      ...
      UIImage* anImage = [UIImage imageNamed:@"spinner.png"];
      UITabBarItem* theItem = [[UITabBarItem alloc] initWithTitle:@"Spinner" image:anImage tag:0];
...
- (void)addExplainingView{
  ...
  ExplainingViewController *controller = [[ExplainingViewController alloc] initWithNibName:@"ExplainingViewController"
                                                                                    bundle:nil 
                                                                                     ...
                                                                                     image:[UIImage imageNamed:@"statusViewWithSpinnerIcon.png"]
                                                                      codeDescriptionTitle:@"To call this statusView, just put the following code in viewDidLoad: "
                                                                           codeDescription:@"" 
                                                                               codeExample:@"statusView = [[OLStatusView alloc] initWithStatusLabel:@\"En cours de chargement\" textFont:[UIFont fontWithName:@\"Helvetica\" size:16] activityIndicatorStyle:UIActivityIndicatorViewStyleWhite orientation:UIInterfaceOrientationPortrait translationDirection:DownToUp];" 
...
- (void)viewDidLoad
{
  ...
  statusView = [[OLStatusView alloc] initWithStatusLabel:@"En cours de chargement" textFont:[UIFont fontWithName:@"Helvetica" size:16] activityIndicatorStyle:UIActivityIndicatorViewStyleWhite orientation:UIInterfaceOrientationPortrait translationDirection:DownToUp];
